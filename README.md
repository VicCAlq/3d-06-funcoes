...
7.  A quantidade total de exercícios é de 12 questões:  
        - 12 do arquivo ex-01-funcoes.js  
8.  Cada exercício vale um máximo de 10 pontos de um total de 10 para a atividade
9.  A quantidade mínima de questões corretas para garantir os 5 pontos 
    para cada exercício é de:  
        - 9 questões corretas para o arquivo ex-01-funcoes.js  
