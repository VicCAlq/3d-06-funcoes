...
*/
// Escreva o código da solução abaixo:
function obterTravaLingua (numero1){
  return travaLinguas[numero1]
}
...
*/
// Escreva o código da solução abaixo:
function contarPalavrasTravaLingua (numero2) {
  return travaLinguas[numero2].split(" ")
}
